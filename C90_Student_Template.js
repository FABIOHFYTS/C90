...
function car1_up() {
  if (car1Y >= 0) {
    car1Y = car1Y - 10;
    console.log(
      "Quando a seta para cima é pressionada, X =  " + car1X + " , Y = " + car1Y
    );
    uploadBackground();
    uploadcar1();
    uploadcar2();
...
function car1_down() {
  if (car1Y <= 500) {
    car1Y = car1Y + 10;
    console.log(
      "Quando a seta para baixo é pressionada, X =  " +
        car1X +
        " , Y = " +
        car1Y
    );
...
function car1_left() {
  if (car1X >= 0) {
    car1X = car1X - 10;
    console.log(
      "Quando a seta esquerda é pressionada, X =  " + car1X + " , Y = " + car1Y
    );
    uploadBackground();
    uploadcar1();
    uploadcar2();
...
function car1_right() {
  if (car1X <= 700) {
    car1X = car1X + 10;
    console.log(
      "Quando a seta direita é pressionada, X =  " + car1X + " , Y = " + car1Y
    );
    uploadBackground();
    uploadcar1();
    uploadcar2();
...
function car2_up() {
  if (car2Y >= 0) {
    car2Y = car2Y - 10;
    console.log(
      "Quando a seta para cima é pressionada, X =  " + car2X + " , Y = " + car2Y
    );
    uploadBackground();
    uploadcar1();
    uploadcar2();
...
function car2_left() {
  if (car2X >= 0) {
    car2X = car2X - 10;
    console.log(
      "Quando a seta esquerda é pressionada, X =  " + car2X + " , Y = " + car2Y
    );
    uploadBackground();
    uploadcar1();
    uploadcar2();
...
function car2_right() {
  if (car2X <= 700) {
    car2X = car2X + 10;
    console.log(
      "Quando a seta direita é pressionada, X =  " + car2X + " , Y = " + car2Y
    );
    uploadBackground();
    uploadcar1();
    uploadcar2();
